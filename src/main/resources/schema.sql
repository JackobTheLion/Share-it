...
create table if not exists bookings (
    ...
    CONSTRAINT fk_booker FOREIGN KEY (user_id) REFERENCES shareit_users (user_id) ON delete CASCADE
);
...
create table if not exists comments (
    ...
    CONSTRAINT fk_user FOREIGN KEY (user_id) REFERENCES shareit_users (user_id) ON delete CASCADE
);